...
const handleFmPlay = async () => {
  ...
  try {
    ...
    playlistStore.setPlayList(playlist, false);
...
const quickNavItems = computed(() => {
  const items = [
    ...
    },
    {
      ...
      icon: 'ri-trophy-line',
      active: action: () => router.push('/toplist'),
      show: true
    },
    {
      key: 'favorite',
      ...
      active: action: () => router.push('/favorite'),
      show: true
    },
    {
      key: 'podcast',
      ...
      active: action: () => router.push('/podcast'),
      show: true
    },
    {
      key: 'mv',
    ...
    },
    {
      ...
      active: action: () => router.push('/list'),
      show: true
    },
    {
      key: 'album',
      ...
      icon: 'ri-album-line',
      active: action: () => router.push('/album'),
      show: true
    },
    {
      key: 'history',
      ...
      active: action: () => router.push('/history'),
      show: true
    }
  ];
...
const playDayRecommend = async () => {
  ...
  try {
    ...
    playlistStore.setPlayList(songs, false);
    const { playTrack } = await import('@/services/playbackController');
